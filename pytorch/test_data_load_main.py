...
for step, sample_batched in enumerate(dataloader.data):
    ...
    print(sample_batched["depth"].shape)
    print("max of depth :", np.max(sample_batched["depth"].numpy()[sample_batched["depth"].numpy()>0]))
    print("min of depth :", np.min(sample_batched["depth"].numpy()[sample_batched["depth"].numpy()>0]))
    print("mean of depth :", np.mean(sample_batched["depth"].numpy()[sample_batched["depth"].numpy()>0]))
    print("ok!")
    break

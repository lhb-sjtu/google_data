...
class silog_loss(nn.Module):
    ...
    # training loss similar with paper


 # need to read  ASSP  paper
...
class local_planar_guidance(nn.Module):
    ...
    def forward(self, plane_eq, focal):
        ...
        return (n4 / (n1 * u + n2 * v + n3)).cuda(device = gpu)
